...
* **Target Hardware:** Philips Hue Bridge (IP: `192.168.68.53`), Hue Motion Sensors (`ZLLPresence`), Temperature Sensors (`ZLLTemperature`), Ambient Light Sensors (`ZLLLightLevel`), and Hue Smart Lights.
* **Core Components:**
  * [hue_motion.py](file:///home/brandon/Documents/Philips_Hue/hue_motion.py): Primary CLI monitoring tool, bridge pairing logic, relative timestamp calculations, and light state mutation helper.
  ...
  * [index.html](file:///home/brandon/Documents/Philips_Hue/index.html): Modern, responsive dark-mode dashboard featuring live motion alerts, temperature/lux metrics, battery bars, audio alerts, and interactive light toggles/sliders.
...
* Maintain dark-mode glassmorphism styling in `index.html` with curated color tokens (`--accent-red`, `--accent-green`, `--accent-yellow`, `--accent-blue`).
